...
export class PoliceSystem {
  ...
  canSee(unit, player) {
    ...
    // la mejora del justiciero: reduce el radio de deteccion de la patrulla,
    // asi que necesita estar mas CERCA de ti para poder verte (mas facil
    // pasar sin que te fichen)
